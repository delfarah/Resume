...
\renewcommand{\headrulewidth}{0pt}
 ...
 \usepackage{enumitem}
\setlist[itemize]{itemsep=0em,topsep=-1.3em}
...
\item Evaluated the effects of combining visual question answering (VQA) algorithms with object detection and image segmentation.
